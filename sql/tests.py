...
class TestDataDictionary(TestCase):
    ...
    def oracle_test_export_db(self, _get_engine):
        ...
        _get_engine.return_value.get_all_databases.return_value.rows.return_value = ResultSet(
            rows=(('test1',), ('test2',)))
        _get_engine.return_value.query.return_value = ResultSet(rows=(
            {'TABLE_NAME': 'aliyun_rds_config', 'TABLE_COMMENTS': 'TABLE', 'COLUMN_NAME': 't1',
             'data_type': 'varcher2(20)', 'DATA_DEFAULT': 'Dynamic', 'NULLABLE': 'Y', 'INDEX_NAME': 'SYS_01',
             'COMMENTS': 'SYS_01'
             },
            {'TABLE_NAME': 'auth_group', 'TABLE_COMMENTS': 'TABLE', 'COLUMN_NAME': 't1', 'data_type': 'varcher2(20)',
             'DATA_DEFAULT': 'Dynamic', 'NULLABLE': 'N', 'INDEX_NAME': 'SYS_01', 'COMMENTS': 'SYS_01'
             }))
        data = {
            'instance_name': self.ins.instance_name,
            'db_name': self.db_name,
